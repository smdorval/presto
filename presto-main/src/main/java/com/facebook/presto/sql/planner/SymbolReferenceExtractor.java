...
public class SymbolReferenceExtractor
{
    ...
    {
        SymbolReferenceExtractingVisitor symbolReferenceExtractingVisitor = new SymbolReferenceExtractingVisitor();
        symbolReferenceExtractingVisitor.process(expression, null);
        return symbolReferenceExtractingVisitor.getSymbolReferences();
    }

    private static class SymbolReferenceExtractingVisitor
