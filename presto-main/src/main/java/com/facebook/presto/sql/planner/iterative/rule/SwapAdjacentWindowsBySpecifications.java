        ...
        implements Rule
{
    ...
    private static int compare(WindowNode o1, WindowNode o2)
    {
        ...
        // If PartitionBy and OrderBy clauses are identical, let' establish an arbitrary order to prevent non-deterministic results of swapping WindowNodes in such a case
