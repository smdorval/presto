        ...
        implements PlanOptimizer
{
            ...
            extends SimplePlanRewriter<Expression>
    {
        ...
        public PlanNode visitSemiJoin(SemiJoinNode node, RewriteContext<Expression> context)
        {
            ...
            if (!SystemSessionProperties.supportNullOnLhsOfSemiJoin(session)) {
                rewrittenFilteringSource = rewriteSemiJoinFilteringSource(node, context, inheritedPredicate, sourceEffectivePredicate);
            }
            else {
        ...
        private PlanNode rewriteSemiJoinFilteringSource(SemiJoinNode node, RewriteContext<Expression> context, Expression inheritedPredicate, Expression sourceEffectivePredicate)
        {
            ...
            return context.rewrite(node.getFilteringSource(), combineConjuncts(filteringSourceConjuncts));
        }
